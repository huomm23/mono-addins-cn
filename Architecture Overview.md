...
![image](Images/Architecture%20Overview/500px-Mono-addins-sample.png)
...
* 当调用**AddinManager.Registry.Update**的时候，插件引擎将会扫描应用程序目录（包括其他用户自定义的插件目录）来搜索插件，然后更新内部的插件注册信息来缓存插件信息。
* **AddinManager.GetExtensionObjects**用来查询一个或多个扩展点，他返回一个匹配了扩展点对象列表。
...
![image](Images/Architecture%20Overview/500px-Addin-arch2.png)
...
![image](Images/Architecture%20Overview/500px-Addin-arch3.png)
...
![image](Images/Architecture%20Overview/500px-Addin-arch4.png)
